...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        if (options.autocomplete) {
            ...
            if ($.fn.textcomplete) {
                ...
                // $.getScript("jquery.textcomplete.js",autocomplete);
            }
        }
    ...
    var cdn = { 
        ...
        defaultBase: mainPathFolder+"/emoji/lib/js/emojione.min.js",
        ...
        if (!cdn.isLoading) {
            if (!emojione || getSupportMode(detectVersion(emojione)) < 2) {
                ...
                if (getSupportMode(emojioneVersion) > 5) {
                    ...
                    emojioneJsCdnUrlBase = mainPathFolder + "/emoji" ;
                }
                $.getScript(emojioneJsCdnUrlBase + "/lib/js/emojione.min.js", function () {
                    ...
                    if (emojioneSupportMode > 4) {
                        ...
                        // sprite = cdn.base + "/sprites/emojione-sprite-" + emojione.emojiSize + ".css";
												cdn.base = mainPathFolder + "/emoji/assets";
                        sprite = mainPathFolder + "/emoji/assets/sprites/emojione-sprite-" + emojione.emojiSize + ".css";
                    } else {
                        // cdn.base = cdn.defaultBase + emojioneVersion + "/assets";
                        // sprite = cdn.base + "/sprites/emojione.sprites.css";
												cdn.base = mainPathFolder + "/emoji/assets";
                        sprite = mainPathFolder + "/emoji/assets/sprites/emojione.sprites.css";
                    }
                    if (options.sprite) {
