            ...
            <div data-ribbon="@if($index == 4 || $index == 5 || $index == 6) -15% @else -40% @endif" class="card card-pricing @if($index == 1 || $index == 2 || $index == 3) popular @else bestseller @endif shadow px-3 mb-4">
                ...
                <div class="bg-transparent card-header pt-4 border-0">
                    @if($index == 3 || $index == 6 || $index == 9)
                        <h3 class="text-center mb-1"><i class="fas fa-crown text-warning"></i></h3>
                    @endif
                    <!-- end crown -->
                ...
                <div class="card-body pt-0 mx-auto">
                    <ul style="@if($account == 1) font-size:14px @else font-size:16px @endif" class="subs list-unstyled mb-4">
                        <li><i class="fas fa-check main-color"></i>&nbsp;Max {{ $pc::format($pc->get_price()[$index]['contestants']) }} {{ Lang::get('order.contestants') }}</li>
                        ...
                        <li>@if($index == 3 || $index == 6 || $index == 9) <i class="fas fa-check main-color"></i>&nbsp; @else <i class="fas fa-minus-circle text-danger"></i>&nbsp; @endif {{ Lang::get('order.wa') }}</li>
                    </ul>
