...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <h1 class="big-theme" align="center">{{ Lang::get('title.redeem') }}</h1>
        </div>

        <!-- FORM -->
        <div class="col-md-8 bg-white px-4 py-4">
            <span id="msg"><!-- --></span>
            <div class="mb-3" align="right">{{ Lang::get('table.fund') }} : {{ $helper::currency()[Lang::get('auth.currency')] }} <b>{{ $helper::format(Auth::user()->money) }}</b></div>
        ...
        <div class="col-md-8 bg-white px-4 py-2">
            ...
            <table id="data_redeem" class="responsive">
                <thead>
                    ...
                    <th>{{Lang::get('table.name.account')}}</th>
                    <th>{{Lang::get('table.no.account')}}</th>
